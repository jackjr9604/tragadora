...
export default async function PayoutsPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return <PublicPageShell payouts={ticker} language={language}>
    <section className="border-b border-white/8 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,.13),transparent_38%)]"><div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24"><p className="font-mono text-xs uppercase tracking-[.22em] text-cyan-300">Payout Tracker</p><h1 className="mt-4 max-w-4xl text-4xl font-bold tracking-tight sm:text-6xl">Ranking de payouts de Prop Firms.</h1><p className="mt-6 max-w-3xl text-lg leading-8 text-slate-400">Explora las cifras de payouts de las principales Prop Firms. Los datos de referencia provienen de seguimiento externo y pueden consultarse por periodo.</p><div className="mt-8"><PeriodTabs active={period} basePath="/payouts" language={language} /></div></div></section>
