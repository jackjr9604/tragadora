...
export const metadata: Metadata = { title: 'Payout Tracker de Prop Firms | Tragadora', description: 'Compara datos externos de referencia con payouts verificados independientemente por Tragadora.' }
