...
export function PlaceholderPublicPage({ content, language, title, subtitle, path }: { content: PageContent; language: PublicLanguage; title: string; subtitle: string; path: string }) {
